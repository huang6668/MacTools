...
| Monitoring & calendar | Follow system performance, device batteries, activity statistics, AI usage, and network status, or combine battery, Wi-Fi, and volume into one menu bar icon and hide the system battery and Wi-Fi icons it replaces. Check your calendar and upcoming events. |
